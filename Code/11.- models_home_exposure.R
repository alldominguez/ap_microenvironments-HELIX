...
### Define Variables
## Exposures
exposures <- c("hs_no2_yr_hs_h_log_iqr", "hs_pm25_yr_hs_h_iqr")
...
### Export Results
table_path <- "output/tables/models/home/"
...
final_plot <- Reduce(`|`, plots) +
  plot_annotation(title = 'A. Exposure to air pollution at home',
                  subtitle = expression("Effect estimate of air pollution at home (" *beta * " (95% CI))")) &
  theme(plot.title = element_text(face = 'bold', size = 16),
        plot.subtitle = element_text(hjust = 0.5, size = 14),
        strip.text.x = element_text(size = 12))

ggsave("output/figures/fig2A_home_forest_plot_adj_cohort_v3.tiff", plot = final_plot, width = 12, height = 3, dpi = 400)
